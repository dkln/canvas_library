var Bitmap, DisplayContainer, DisplayObject, EaseDefault, Renderer, Shape, StackedLoader, Stage, TextField, Tween, TweenCommand, Utils;
...
StackedLoader = (function() {
  ...
  StackedLoader.loadString = function() {
    ...
    return this.stack[this.toLoad.id].onreadystatechange = __bind(function() {
      if (this.stack[this.toLoad.id].readyState === 4 && this.stack[this.toLoad.id].status === 200) {
        return this.handleStringLoadComplete();
      }
    }, this);
  };
